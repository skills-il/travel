# Israeli Airlines Baggage Quick Reference

Quick-reference table for baggage policies of airlines operating from Ben Gurion (TLV).
Prices and policies are subject to change -- always verify on the airline's website before booking.
...
| Wizz Air | 10 kg | 55x40x23 cm | 1 (40x30x20 cm) | Free personal item only on base fare; cabin bag requires WIZZ Priority or higher |

## Checked Baggage

| Airline | Fare Type | Bags Included | Weight per Bag | Extra Bag Cost |
|---------|-----------|---------------|----------------|----------------|
| **El Al** | Economy Lite | 0 | -- | Purchase add-on |
| | Economy Classic | 1 | 23 kg | Add-on for 2nd |
...
| Airline | Overweight (per kg) | Oversized |
|---------|--------------------| ----------|
| El Al | Check elal.com | Max 158 cm linear |
| Israir | Check israir.co.il | -- |
| Arkia | $10/EUR 10 per kg | Check arkia.com |
| Wizz Air | Check wizz.com | Max 149 cm linear |
